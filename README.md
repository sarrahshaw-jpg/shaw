# Noor — executive assistant for Ali Rao, built inside Claude
...
| [claude/PROJECT_INSTRUCTIONS.md](claude/PROJECT_INSTRUCTIONS.md) | the assistant's brain; paste into the Project. Its name, `Noor`, and the voice rules live here and in `00-config.md` |
